...
export default function Users() {
  ...
  const columns = useMemo(() => [
    ...
    columnHelper.accessor('role', {
      header: 'CLEARANCE',
      cell: info => (
        <span className={`px-3 py-1 font-label text-[10px] font-black uppercase tracking-widest border-2 border-theme-border ${
          info.getValue() === 'admin' ? 'bg-red-500 text-white' : 'bg-gray-200 text-theme-text'
        }`}>
          {info.getValue()}
        </span>
      ),
      ...
      cell: info => (
        <div className="flex items-center gap-2">
          <motion.button
            ...
            className="p-2 border-2 border-theme-border bg-theme-bg hover:bg-[var(--color-primary)] transition-colors"
            title="Edit User"
          >
    ...
    <div className="w-full relative z-10 space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b-8 border-theme-border pb-6 gap-6">
        ...
        <motion.button
          ...
          onClick={() => openModal()}
          className="flex items-center gap-2 px-6 py-4 bg-[var(--color-primary)] text-black border-4 border-theme-border font-display font-black uppercase text-xl shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] transition-all"
        >
              ...
              {initialFetch ? (
                Array.from({ length: 5 }).map((_, i) => (
                  <TableRow key={i} className="border-b-4 border-theme-border last:border-b-0">
                    <TableCell className="p-6 border-r-4 border-theme-border"><Skeleton className="h-5 w-32 bg-gray-200 rounded-none" /></TableCell>
                    <TableCell className="p-6 border-r-4 border-theme-border"><Skeleton className="h-4 w-48 bg-gray-200 rounded-none" /></TableCell>
                    <TableCell className="p-6 border-r-4 border-theme-border"><Skeleton className="h-6 w-16 bg-gray-200 rounded-none" /></TableCell>
                    <TableCell className="p-6 border-r-4 border-theme-border"><Skeleton className="h-4 w-24 bg-gray-200 rounded-none" /></TableCell>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-12" onClick={closeModal}>
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-theme-bg border-4 border-theme-border shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] flex flex-col max-h-[90vh]"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 bg-theme-bg">
                <div className="overflow-y-auto flex-1 p-6 md:p-8 space-y-6" data-lenis-prevent>
                  
                  {/* Name Input */}
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 font-label text-xs font-black uppercase tracking-widest text-theme-text">
                    ...
                    <input 
                      ...
                      className="w-full border-4 border-theme-border p-4 font-display text-xl uppercase tracking-wider font-black focus:outline-none focus:border-[var(--color-primary)] focus:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] transition-all bg-theme-bg"
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full border-4 border-theme-border p-4 font-label text-sm tracking-wider font-bold focus:outline-none focus:border-[var(--color-primary)] focus:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] transition-all bg-theme-bg"
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full border-4 border-theme-border p-4 font-label text-xl tracking-[0.5em] font-black focus:outline-none focus:border-[var(--color-primary)] focus:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] transition-all bg-theme-bg"
                      placeholder="********"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full border-4 border-theme-border p-4 font-display text-lg uppercase tracking-wider font-black appearance-none focus:outline-none focus:border-[var(--color-primary)] focus:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] transition-all bg-theme-bg cursor-pointer"
                      >
        ...
        {userToDelete && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 md:p-12" onClick={() => setUserToDelete(null)}>
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-red-500 border-8 border-theme-border shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] flex flex-col"
              onClick={e => e.stopPropagation()}
            >
              ...
              <div className="flex flex-col sm:flex-row bg-[#f4f4f4] p-6 gap-4">
                  <motion.button
                    ...
                    className="flex-1 px-6 py-4 border-4 border-theme-border bg-theme-bg font-display text-lg font-black uppercase tracking-tight text-theme-text transition-all"
                  >
                    ABORT
                  </motion.button>
                  <motion.button
                    ...
                    className="flex-1 bg-red-500 border-4 border-theme-border text-white px-6 py-4 font-display text-lg font-black uppercase tracking-tight transition-all hover:bg-red-600"
                  >
                    EXECUTE PURGE
                  </motion.button>
              </div>
