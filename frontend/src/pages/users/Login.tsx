        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-baseline">
                ...
                <Link to="/forgot-password" className="font-label text-[0.7rem] text-gray-500 hover:text-theme-text hover:underline underline-offset-4 decoration-2 font-bold transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-12 text-center">
            <p className="font-body text-[0.875rem] text-gray-500 font-medium">
              Don't have an account? <Link to="/register" className="text-theme-text font-bold hover:text-[var(--color-primary)] hover:underline decoration-4 underline-offset-4 transition-colors ml-1">Sign up</Link>
            </p>
          </div>
