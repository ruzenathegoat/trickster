...
export default function UserProfile() {
  ...
  if (!profileData) {
    return (
      <div className="max-w-7xl pb-24 space-y-8">
        ...
        <Skeleton className="h-[400px] w-full border-4 border-theme-border" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl pb-24">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-3 md:gap-4">
            ...
            <div className="flex gap-4">
              <span className="font-label text-sm uppercase tracking-widest bg-[var(--color-primary)] text-black px-3 py-1 font-black shadow-[4px_4px_0px_0px_var(--color-theme-shadow)]">
                {profileData.role || 'USER'}
              </span>
              {profileData.favorite_role && (
                <span className="font-label text-sm uppercase tracking-widest border-2 border-white bg-black px-3 py-1 font-bold shadow-[4px_4px_0px_0px_var(--color-theme-bg)]">
                  {profileData.favorite_role}
                </span>
              )}
            </div>
      ...
      {/* Tab Navigation */}
      <div className="flex flex-col md:flex-row flex-wrap gap-3 md:gap-4 mb-8 border-b-4 border-theme-border pb-4">
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-3 w-full md:w-auto px-4 md:px-6 py-3 font-display uppercase tracking-widest text-base md:text-xl border-4 border-theme-border transition-all ${
                activeTab === tab.id 
                  ? 'bg-black text-[var(--color-primary)] shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] translate-x-1 -translate-y-1' 
                  : 'bg-theme-bg text-theme-text hover:bg-[var(--color-primary)] hover:text-black hover:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] hover:-translate-y-1'
              }`}
            >
      ...
      <div className="min-h-[400px]">
        ...
        {activeTab === 'account' && (
          ...
          >
            {/* Account Form */}
            <div className="border-4 border-theme-border p-6 bg-theme-bg shadow-[4px_4px_0px_0px_var(--color-theme-shadow)]">
              <h2 className="text-2xl font-display uppercase tracking-tight border-b-4 border-theme-border pb-4 mb-6 flex items-center gap-3">
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border-2 border-theme-border p-3 font-bold font-sans focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] bg-theme-bg text-theme-text"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border-2 border-theme-border p-2 font-bold font-sans text-sm file:mr-4 file:py-2 file:px-4 file:border-2 file:border-theme-border file:text-sm file:font-black file:uppercase file:bg-[var(--color-primary)] file:text-black hover:file:bg-black hover:file:text-[var(--color-primary)] transition-colors cursor-pointer bg-theme-bg text-theme-text"
                  />
                </div>
                <button 
                  type="submit" 
                  className="w-full bg-black text-white font-label font-black uppercase tracking-widest p-4 hover:bg-[var(--color-primary)] hover:text-black transition-colors border-2 border-theme-border"
                  disabled={loading}
                >
            ...
            <div className="border-4 border-theme-border p-6 bg-theme-bg shadow-[4px_4px_0px_0px_var(--color-theme-shadow)]">
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="w-full border-4 border-theme-border font-label font-black uppercase tracking-widest p-4 hover:bg-[var(--color-primary)] hover:text-black transition-colors mt-auto bg-theme-bg text-theme-text"
                  disabled={loading}
                >
        ...
        {activeTab === 'favorites' && (
          ...
          >
            {/* Favorite Players */}
            <div>
              <h2 className="text-2xl md:text-3xl font-display uppercase tracking-tight border-b-4 border-theme-border pb-4 mb-6 flex items-center gap-3">
              ...
              {profileData.favorite_players && profileData.favorite_players.length > 0 ? (
                <div className="flex flex-col gap-4">
                  {profileData.favorite_players.map((player: any) => (
                    <div key={player.id} className="border-4 border-theme-border bg-theme-bg p-3 md:p-4 flex items-center justify-between shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] gap-2">
                      <Link to={`/app/players/${player.id}`} className="flex items-center gap-3 md:gap-4 group min-w-0 flex-1">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-200 border-2 border-theme-border overflow-hidden shrink-0">
                          {player.photo_url ? (
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-display text-lg md:text-2xl uppercase leading-none group-hover:text-[var(--color-primary)] transition-colors text-theme-text truncate">{player.ign}</h3>
                      ...
                      <button 
                        ...
                        className="p-2 md:p-3 bg-theme-bg text-theme-text hover:bg-black hover:text-[#ff3333] border-4 border-theme-border transition-colors shrink-0"
              ...
              {profileData.favorite_teams && profileData.favorite_teams.length > 0 ? (
                <div className="flex flex-col gap-4">
                  {profileData.favorite_teams.map((team: any) => (
                    <div key={team.id} className="border-4 border-theme-border bg-theme-bg p-3 md:p-4 flex items-center justify-between shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] gap-2">
                      <Link to={`/app/teams/${team.id}`} className="flex items-center gap-3 md:gap-4 group min-w-0 flex-1">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-theme-bg border-2 border-theme-border overflow-hidden flex items-center justify-center p-1 md:p-2 shrink-0">
                          {team.logo_url ? (
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-display text-lg md:text-2xl uppercase leading-none group-hover:text-[var(--color-primary)] transition-colors text-theme-text truncate">{team.name}</h3>
            ...
            {profileData.saved_simulations && profileData.saved_simulations.length > 0 ? (
              <div className="flex flex-col gap-4">
                {profileData.saved_simulations.map((sim: any) => (
                  <div key={sim.id} className="border-4 border-theme-border bg-theme-bg p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] md:shadow-[4px_4px_0px_0px_var(--color-theme-shadow)] group gap-4">
                    <div className="min-w-0">
                      <h3 className="font-display text-xl md:text-3xl uppercase leading-none text-theme-text truncate">{sim.name}</h3>
