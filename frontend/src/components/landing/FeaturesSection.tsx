    ...
    <section className="w-full bg-[var(--color-background)] py-24 md:py-32 relative z-10 border-b-2 border-[var(--color-on-background)] overflow-hidden">
      ...
      <div className="max-w-[var(--spacing-max-width)] mx-auto px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] relative z-10">
        ...
        <div className="mb-16 md:mb-24 text-center">
          <h2 className="font-['Archivo_Black'] text-[3rem] md:text-[4rem] font-black uppercase tracking-tighter text-[var(--color-on-background)] leading-none">
            UNFAIR ADVANTAGE.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="md:col-span-2 bg-[var(--color-surface)] border-2 border-[var(--color-on-background)] brutal-shadow cut-corner overflow-hidden group">
            <div className="h-48 md:h-64 bg-[var(--color-surface-variant)] border-b-2 border-[var(--color-on-background)] flex items-center justify-center p-8 relative overflow-hidden group-hover:bg-[var(--color-primary-container)] transition-colors duration-300">
               <MagnifyingGlass weight="bold" className="text-[4rem] md:text-[6rem] text-[var(--color-on-background)] opacity-20 absolute -right-4 -bottom-4 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300" />
            </div>
            <div className="p-8">
              <h3 className="font-['Archivo_Black'] text-[1.5rem] font-bold uppercase mb-2">Deep Scouting</h3>
          ...
          <div className="md:col-span-1 bg-[var(--color-primary)] border-2 border-[var(--color-on-background)] brutal-shadow cut-corner overflow-hidden group">
            <div className="h-48 md:h-64 border-b-2 border-[var(--color-on-background)] flex items-center justify-center p-8 relative overflow-hidden">
               <ChartBar weight="bold" className="text-[4rem] md:text-[6rem] text-[var(--color-on-background)] opacity-20 absolute right-4 bottom-4 group-hover:opacity-100 group-hover:-translate-y-4 transition-all duration-300" />
            </div>
            <div className="p-8">
              <h3 className="font-['Archivo_Black'] text-[1.5rem] font-bold uppercase mb-2">Contextual Analytics</h3>
          ...
          <div className="md:col-span-1 bg-[var(--color-surface)] border-2 border-[var(--color-on-background)] brutal-shadow cut-corner overflow-hidden group">
            <div className="h-48 md:h-64 bg-[var(--color-surface-variant)] border-b-2 border-[var(--color-on-background)] flex items-center justify-center p-8 relative overflow-hidden group-hover:bg-[var(--color-primary-container)] transition-colors duration-300">
               <Sword weight="bold" className="text-[4rem] md:text-[6rem] text-[var(--color-on-background)] opacity-20 absolute left-4 bottom-4 group-hover:opacity-100 group-hover:rotate-12 transition-all duration-300" />
            </div>
            <div className="p-8">
              <h3 className="font-['Archivo_Black'] text-[1.5rem] font-bold uppercase mb-2">Head-to-Head</h3>
              <p className="font-['Inter'] text-[1rem] text-[var(--color-secondary)]">
          ...
          <div className="md:col-span-2 bg-[var(--color-surface)] border-2 border-[var(--color-on-background)] brutal-shadow cut-corner overflow-hidden group">
            <div className="h-48 md:h-64 bg-[var(--color-surface-variant)] border-b-2 border-[var(--color-on-background)] flex items-center justify-center p-8 relative overflow-hidden group-hover:bg-[var(--color-primary-container)] transition-colors duration-300">
               <UsersThree weight="bold" className="text-[4rem] md:text-[6rem] text-[var(--color-on-background)] opacity-20 absolute -right-4 -bottom-4 group-hover:opacity-100 group-hover:translate-x-4 transition-all duration-300" />
            </div>
            <div className="p-8">
              <h3 className="font-['Archivo_Black'] text-[1.5rem] font-bold uppercase mb-2">Roster Simulation</h3>
              <p className="font-['Inter'] text-[1rem] text-[var(--color-secondary)]">
